...
second_user = User.create(name: 'Maggie', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Teacher from Seria leone.')
third_user = User.create(name: 'Phillipe', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Developer from Togo.')
fourth_user = User.create(name: 'Agnet', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Singer from Russia.')
